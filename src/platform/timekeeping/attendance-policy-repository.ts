...
import type { AttendancePolicyRecord, BreakRule, GracePeriodRule, OvertimeRule, PolicyScope, RoundingRule, ToleranceRule } from "@/platform/timekeeping/attendance-policy";
...
export interface AttendancePolicyReadRepository {
  findById(context: TenantContext, attendancePolicyVersionId: string): Promise<AttendancePolicyRecord | undefined>;
